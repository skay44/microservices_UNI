...
import aui.skay44.lab3.service.impl.MiningDrillService;
...
public class DataInitializer {
    ...
    public void constuct(){
        ...
        asteroids[0] = Asteroid.builder().id(UUID.fromString("525d3e7b-bb1f-4c13-bf17-926d1a12e4c0")).build();
        asteroids[1] = Asteroid.builder().id(UUID.fromString("3c6f1eb1-8069-44ab-988f-d7fed2b65d87")).build();
        asteroids[2] = Asteroid.builder().id(UUID.fromString("81e1c2a9-7f57-439b-b53d-6db88b071e4e")).build();
